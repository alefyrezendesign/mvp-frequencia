...
import { AttendanceStatus, CabinetStatus, Unit, Member, FrequencyCategory, AttendanceRecord, CabinetFollowUp } from '../types';
...
const FollowUpView: React.FC<FollowUpViewProps> = ({ store, selectedUnit }) => {
  ...
  const activeFollowUps = useMemo(() =>
    allFollowUps.filter((m: any) => m.cabinetStatus !== CabinetStatus.DONE)
